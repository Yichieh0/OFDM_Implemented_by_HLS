...
#pragma HLS INTERFACE m_axi depth=1536 port=out_mem_deQAM_real bundle=gmem1
#pragma HLS INTERFACE m_axi depth=1536 port=out_mem_deQAM_imag bundle=gmem2
...
#pragma HLS dataflow
	...
	hls::stream<ap_uint<pixl_bit>, FFT_LEN> temp_in;
	hls::stream<ap_uint<pixl_bit>, FFT_LEN> temp_out;
