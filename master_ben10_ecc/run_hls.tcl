...
add_files "src/convolution_code/encoder.cpp src/convolution_code/encoder.h src/convolution_code/decoder.cpp src/convolution_code/decoder.h " -cflags "-I${XF_PROJ_ROOT}/L1/include/hw/vitis_fft/fixed"
add_files "src/master_mem/master2stream.cpp src/master_mem/master2stream.h " -cflags "-I${XF_PROJ_ROOT}/L1/include/hw/vitis_fft/fixed"
add_files "src/master_mem/stream2master.cpp src/master_mem/stream2master.h src/master_mem/stream2master_output_QAM.cpp src/master_mem/stream2master_output_QAM.h " -cflags "-I${XF_PROJ_ROOT}/L1/include/hw/vitis_fft/fixed"
add_files "src/master_top.cpp src/master_top.h " -cflags "-I${XF_PROJ_ROOT}/L1/include/hw/vitis_fft/fixed"
